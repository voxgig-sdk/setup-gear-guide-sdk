...
describe("GetBuildDirect", function()
  it("should direct-load-get_build", function()
    local setup = get_build_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_build", setup.live and "live" or "unit")
