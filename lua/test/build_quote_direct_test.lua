...
describe("BuildQuoteDirect", function()
  it("should direct-load-build_quote", function()
    local setup = build_quote_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-build_quote", setup.live and "live" or "unit")
