...
describe("CheckCompatibilityDirect", function()
  it("should direct-load-check_compatibility", function()
    local setup = check_compatibility_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-check_compatibility", setup.live and "live" or "unit")
