...
describe("GetProductDirect", function()
  it("should direct-load-get_product", function()
    local setup = get_product_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_product", setup.live and "live" or "unit")
