...
function runner.env_override(m)
  local live = runner.getenv("SETUP_GEAR_GUIDE_TEST_LIVE")
  local override = runner.getenv("SETUP_GEAR_GUIDE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SETUP_GEAR_GUIDE_TEST_EXPLAIN")
