...
function runner.env_override(m)
  local live = runner.getenv("SETUPGEARGUIDE_TEST_LIVE")
  local override = runner.getenv("SETUPGEARGUIDE_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("SETUPGEARGUIDE_TEST_EXPLAIN")
