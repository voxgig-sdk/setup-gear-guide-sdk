...
describe("CompareProductEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SETUPGEARGUIDE_TEST_COMPARE_PRODUCT_ENTID JSON to run live")
      return
    end
...
function compare_product_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SETUPGEARGUIDE_TEST_COMPARE_PRODUCT_ENTID")
