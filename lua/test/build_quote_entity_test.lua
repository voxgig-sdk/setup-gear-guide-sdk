...
describe("BuildQuoteEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SETUP_GEAR_GUIDE_TEST_BUILD_QUOTE_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    build_quote_ref01_data = helpers.to_map(type(build_quote_ref01_data_result) == 'table' and build_quote_ref01_data_result.data_get and build_quote_ref01_data_result:data_get() or build_quote_ref01_data_result)
...
function build_quote_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SETUP_GEAR_GUIDE_TEST_BUILD_QUOTE_ENTID")
