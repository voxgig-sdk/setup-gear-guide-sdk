...
local SDK_MODULE = "setup-gear-guide_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["build_quote"] = { ["test01"] = { id = "test01" } }, ["check_compatibility"] = { ["test01"] = { id = "test01" } }, ["compare_product"] = { ["test01"] = { id = "test01" } }, ["get_affiliate_offer"] = { ["test01"] = { id = "test01" } }, ["get_build"] = { ["test01"] = { id = "test01" } }, ["get_product"] = { ["test01"] = { id = "test01" } }, ["recommend_product"] = { ["test01"] = { id = "test01" } } } }'
