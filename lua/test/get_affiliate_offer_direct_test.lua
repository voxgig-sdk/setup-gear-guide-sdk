...
describe("GetAffiliateOfferDirect", function()
  it("should direct-load-get_affiliate_offer", function()
    local setup = get_affiliate_offer_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_affiliate_offer", setup.live and "live" or "unit")
