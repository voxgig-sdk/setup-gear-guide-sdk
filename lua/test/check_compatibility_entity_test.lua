...
describe("CheckCompatibilityEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set SETUP_GEAR_GUIDE_TEST_CHECK_COMPATIBILITY_ENTID JSON to run live")
      return
    end
    ...
    assert.is_nil(err)
    check_compatibility_ref01_data = helpers.to_map(type(check_compatibility_ref01_data_result) == 'table' and check_compatibility_ref01_data_result.data_get and check_compatibility_ref01_data_result:data_get() or check_compatibility_ref01_data_result)
...
function check_compatibility_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("SETUP_GEAR_GUIDE_TEST_CHECK_COMPATIBILITY_ENTID")
