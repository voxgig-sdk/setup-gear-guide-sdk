...
describe("RecommendProductDirect", function()
  it("should direct-load-recommend_product", function()
    local setup = recommend_product_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-recommend_product", setup.live and "live" or "unit")
