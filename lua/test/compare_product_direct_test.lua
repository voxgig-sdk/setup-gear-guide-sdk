...
describe("CompareProductDirect", function()
  it("should direct-load-compare_product", function()
    local setup = compare_product_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-compare_product", setup.live and "live" or "unit")
