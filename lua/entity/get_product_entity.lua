...
local GetProductEntity = {}
GetProductEntity.__index = GetProductEntity


function GetProductEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetProductEntity)
  self._name = "get_product"
  self._client = client
...
function GetProductEntity:get_name()
  return self._name
end


function GetProductEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetProductEntity.new(self._client, opts)
end
...
function GetProductEntity:mark_deleted()
  self._deleted = true
end


function GetProductEntity:deleted()
  return true == self._deleted
end


function GetProductEntity:data_set(args)
  if args ~= nil then
...
function GetProductEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetProductEntity:match_set(args)
  if args ~= nil then
...
function GetProductEntity:match_get()
...
function GetProductEntity:stream(action, args, callopts)
...
---@param reqmatch GetProductLoadMatch
---@param ctrl? table
---@return GetProduct
---@return string? err
function GetProductEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetProductEntity:_run_op(ctx, post_done)
  local utility = self._utility
