...
local GetBuildEntity = {}
GetBuildEntity.__index = GetBuildEntity


function GetBuildEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetBuildEntity)
  self._name = "get_build"
  self._client = client
...
function GetBuildEntity:get_name()
  return self._name
end


function GetBuildEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetBuildEntity.new(self._client, opts)
end
...
function GetBuildEntity:mark_deleted()
  self._deleted = true
end


function GetBuildEntity:deleted()
  return true == self._deleted
end


function GetBuildEntity:data_set(args)
  if args ~= nil then
...
function GetBuildEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetBuildEntity:match_set(args)
  if args ~= nil then
...
function GetBuildEntity:match_get()
...
function GetBuildEntity:stream(action, args, callopts)
...
---@param reqmatch GetBuildLoadMatch
---@param ctrl? table
---@return GetBuild
---@return string? err
function GetBuildEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetBuildEntity:_run_op(ctx, post_done)
  local utility = self._utility
