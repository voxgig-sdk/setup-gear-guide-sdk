...
local GetAffiliateOfferEntity = {}
GetAffiliateOfferEntity.__index = GetAffiliateOfferEntity


function GetAffiliateOfferEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GetAffiliateOfferEntity)
  self._name = "get_affiliate_offer"
  self._client = client
...
function GetAffiliateOfferEntity:get_name()
  return self._name
end


function GetAffiliateOfferEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GetAffiliateOfferEntity.new(self._client, opts)
end
...
function GetAffiliateOfferEntity:mark_deleted()
  self._deleted = true
end


function GetAffiliateOfferEntity:deleted()
  return true == self._deleted
end


function GetAffiliateOfferEntity:data_set(args)
  if args ~= nil then
...
function GetAffiliateOfferEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GetAffiliateOfferEntity:match_set(args)
  if args ~= nil then
...
function GetAffiliateOfferEntity:match_get()
...
function GetAffiliateOfferEntity:stream(action, args, callopts)
...
---@param reqmatch GetAffiliateOfferLoadMatch
---@param ctrl? table
---@return GetAffiliateOffer
---@return string? err
function GetAffiliateOfferEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function GetAffiliateOfferEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return GetAffiliateOfferEntity
