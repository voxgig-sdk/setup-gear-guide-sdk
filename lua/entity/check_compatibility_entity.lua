...
local CheckCompatibilityEntity = {}
CheckCompatibilityEntity.__index = CheckCompatibilityEntity


function CheckCompatibilityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CheckCompatibilityEntity)
  self._name = "check_compatibility"
  self._client = client
...
function CheckCompatibilityEntity:get_name()
  return self._name
end


function CheckCompatibilityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CheckCompatibilityEntity.new(self._client, opts)
end
...
function CheckCompatibilityEntity:mark_deleted()
  self._deleted = true
end


function CheckCompatibilityEntity:deleted()
  return true == self._deleted
end


function CheckCompatibilityEntity:data_set(args)
  if args ~= nil then
...
function CheckCompatibilityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CheckCompatibilityEntity:match_set(args)
  if args ~= nil then
...
function CheckCompatibilityEntity:match_get()
...
function CheckCompatibilityEntity:stream(action, args, callopts)
...
---@param reqmatch CheckCompatibilityLoadMatch
---@param ctrl? table
---@return CheckCompatibility
---@return string? err
function CheckCompatibilityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata CheckCompatibilityCreateData
---@param ctrl? table
---@return CheckCompatibility
---@return string? err
function CheckCompatibilityEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function CheckCompatibilityEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CheckCompatibilityEntity
