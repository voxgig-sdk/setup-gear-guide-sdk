...
class GetAffiliateOfferEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set SETUP_GEAR_GUIDE_TEST_GET_AFFILIATE_OFFER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function get_affiliate_offer_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("SETUP_GEAR_GUIDE_TEST_GET_AFFILIATE_OFFER_ENTID");
