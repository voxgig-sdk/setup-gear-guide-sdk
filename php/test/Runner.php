...
class SetupGearGuideTestRunner
{
    ...
    {
        $live = self::getenv('SETUP_GEAR_GUIDE_TEST_LIVE');
        $override = self::getenv('SETUP_GEAR_GUIDE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SETUP_GEAR_GUIDE_TEST_EXPLAIN');
...
class_alias('SetupGearGuideTestRunner', 'Runner');
class_alias('SetupGearGuideHelpers', 'Helpers');
