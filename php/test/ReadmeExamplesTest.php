...
// SetupGearGuide SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SetupGearGuideSDK::test)
...
{
    private const SDK_CLASS = 'SetupGearGuideSDK';
    ...
    private const SDK_BASE = 'setupgearguide_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../setupgearguide_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
