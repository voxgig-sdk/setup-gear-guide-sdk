...
// SetupGearGuide SDK utility type

class SetupGearGuideUtility
{
    ...
    public static function copy(SetupGearGuideUtility $src): SetupGearGuideUtility
    {
        $u = new SetupGearGuideUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
