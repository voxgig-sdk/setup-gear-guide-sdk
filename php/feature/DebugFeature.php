...
// SetupGearGuide SDK debug feature
...
class SetupGearGuideDebugFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _finish(SetupGearGuideContext $ctx, bool $ok): void
    {
