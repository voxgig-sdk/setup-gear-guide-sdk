...
// SetupGearGuide SDK metrics feature
...
class SetupGearGuideMetricsFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _record(SetupGearGuideContext $ctx, bool $ok): void
    {
