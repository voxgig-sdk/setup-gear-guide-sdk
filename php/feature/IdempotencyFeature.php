...
// SetupGearGuide SDK idempotency feature
...
class SetupGearGuideIdempotencyFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _mutating(SetupGearGuideContext $ctx): bool
    {
