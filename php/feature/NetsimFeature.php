...
// SetupGearGuide SDK netsim feature
...
class SetupGearGuideNetsimFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _simulate(SetupGearGuideContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SetupGearGuideContext $ctx, array $applied): void
    {
        $client = $this->client;
