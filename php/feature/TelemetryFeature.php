...
// SetupGearGuide SDK telemetry feature
...
class SetupGearGuideTelemetryFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _close(SetupGearGuideContext $ctx, bool $ok): void
    {
