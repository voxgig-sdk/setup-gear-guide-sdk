...
// SetupGearGuide SDK proxy feature
...
class SetupGearGuideProxyFeature extends SetupGearGuideBaseFeature
{
    ...
    public function init(SetupGearGuideContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SetupGearGuideContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
