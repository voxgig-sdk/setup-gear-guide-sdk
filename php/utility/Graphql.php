...
// SetupGearGuide SDK utility: graphql
//
...
class SetupGearGuideGraphql
{
    ...
    // equivalent.
    public static function body(SetupGearGuideContext $ctx): mixed
    {
    ...
    public static function errors(SetupGearGuideContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
