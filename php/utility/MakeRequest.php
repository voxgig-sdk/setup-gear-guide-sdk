...
// SetupGearGuide SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SetupGearGuideMakeRequest
{
    public static function call(SetupGearGuideContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SetupGearGuideResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SetupGearGuideResponse($fetched);
        } else {
