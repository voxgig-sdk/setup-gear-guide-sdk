...
// SetupGearGuide SDK utility: make_options

class SetupGearGuideMakeOptions
{
    ...
    public static function call(SetupGearGuideContext $ctx): array
    {
        ...
        //
        // `SetupGearGuideSchema::optspec()` is built from the model:
        ...
        $optspec = SetupGearGuideSchema::optspec();
