...
// SetupGearGuide SDK BuildQuote entity
...
class BuildQuoteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BuildQuoteEntity($this->_client, $opts);
    }

    /**
     * @param BuildQuote|array $args BuildQuote data (assoc-array) to store.
     */
    ...
    /**
     * @return BuildQuote|array The current BuildQuote data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BuildQuote fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BuildQuote fields).
     */
    ...
    /**
     * Load a single BuildQuote.
     *
     * @param BuildQuoteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BuildQuoteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BuildQuote|array The loaded BuildQuote as an assoc-array at the
    ...
    /**
     * Create a new BuildQuote.
     *
     * @param BuildQuoteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BuildQuoteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BuildQuote|array The created BuildQuote as an assoc-array at the
     *   SDK boundary; throws SetupGearGuideError on failure (item-5 convention).
     */
