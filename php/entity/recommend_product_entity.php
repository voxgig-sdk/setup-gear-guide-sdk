...
// SetupGearGuide SDK RecommendProduct entity
...
class RecommendProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RecommendProductEntity($this->_client, $opts);
    }

    /**
     * @param RecommendProduct|array $args RecommendProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return RecommendProduct|array The current RecommendProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RecommendProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RecommendProduct fields).
     */
    ...
    /**
     * Load a single RecommendProduct.
     *
     * @param RecommendProductLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RecommendProductLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RecommendProduct|array The loaded RecommendProduct as an assoc-array at the
    ...
    /**
     * Create a new RecommendProduct.
     *
     * @param RecommendProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RecommendProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RecommendProduct|array The created RecommendProduct as an assoc-array at the
     *   SDK boundary; throws SetupGearGuideError on failure (item-5 convention).
     */
