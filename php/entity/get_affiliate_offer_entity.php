...
// SetupGearGuide SDK GetAffiliateOffer entity
...
class GetAffiliateOfferEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "get_affiliate_offer";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GetAffiliateOfferEntity($this->_client, $opts);
    }

    /**
     * @param GetAffiliateOffer|array $args GetAffiliateOffer data (assoc-array) to store.
     */
    ...
    /**
     * @return GetAffiliateOffer|array The current GetAffiliateOffer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetAffiliateOffer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetAffiliateOffer fields).
     */
    ...
    /**
     * Load a single GetAffiliateOffer.
     *
     * @param GetAffiliateOfferLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetAffiliateOfferLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetAffiliateOffer|array The loaded GetAffiliateOffer as an assoc-array at the
