...
// SetupGearGuide SDK GetBuild entity
...
class GetBuildEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetBuildEntity($this->_client, $opts);
    }

    /**
     * @param GetBuild|array $args GetBuild data (assoc-array) to store.
     */
    ...
    /**
     * @return GetBuild|array The current GetBuild data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetBuild fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetBuild fields).
     */
    ...
    /**
     * Load a single GetBuild.
     *
     * @param GetBuildLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetBuildLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetBuild|array The loaded GetBuild as an assoc-array at the
