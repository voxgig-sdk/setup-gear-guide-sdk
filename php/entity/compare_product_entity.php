...
// SetupGearGuide SDK CompareProduct entity
...
class CompareProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CompareProductEntity($this->_client, $opts);
    }

    /**
     * @param CompareProduct|array $args CompareProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return CompareProduct|array The current CompareProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of CompareProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of CompareProduct fields).
     */
    ...
    /**
     * Load a single CompareProduct.
     *
     * @param CompareProductLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CompareProductLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompareProduct|array The loaded CompareProduct as an assoc-array at the
    ...
    /**
     * Create a new CompareProduct.
     *
     * @param CompareProductCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CompareProductCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return CompareProduct|array The created CompareProduct as an assoc-array at the
     *   SDK boundary; throws SetupGearGuideError on failure (item-5 convention).
     */
