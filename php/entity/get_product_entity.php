...
// SetupGearGuide SDK GetProduct entity
...
class GetProductEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GetProductEntity($this->_client, $opts);
    }

    /**
     * @param GetProduct|array $args GetProduct data (assoc-array) to store.
     */
    ...
    /**
     * @return GetProduct|array The current GetProduct data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GetProduct fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GetProduct fields).
     */
    ...
    /**
     * Load a single GetProduct.
     *
     * @param GetProductLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GetProductLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GetProduct|array The loaded GetProduct as an assoc-array at the
