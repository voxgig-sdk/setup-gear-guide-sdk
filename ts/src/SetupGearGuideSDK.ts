...
class SetupGearGuideSDK {
  ...
  BuildQuote(data?: any) {
    const self = this
    return new BuildQuoteEntity(self,data)
  }
  ...
  CheckCompatibility(data?: any) {
    const self = this
    return new CheckCompatibilityEntity(self,data)
  }


  // Entity access: `client.CompareProduct().list()` / `client.CompareProduct().load({ id })`.
  CompareProduct(data?: any) {
    const self = this
    return new CompareProductEntity(self,data)
  }


  // Entity access: `client.GetAffiliateOffer().list()` / `client.GetAffiliateOffer().load({ id })`.
  GetAffiliateOffer(data?: any) {
    const self = this
    return new GetAffiliateOfferEntity(self,data)
  }
  ...
  GetBuild(data?: any) {
    const self = this
    return new GetBuildEntity(self,data)
  }
  ...
  GetProduct(data?: any) {
    const self = this
    return new GetProductEntity(self,data)
  }


  // Entity access: `client.RecommendProduct().list()` / `client.RecommendProduct().load({ id })`.
  RecommendProduct(data?: any) {
    const self = this
    return new RecommendProductEntity(self,data)
  }
