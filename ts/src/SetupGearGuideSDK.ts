...
class SetupGearGuideSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('SetupGearGuideSDK: graphql: ' +
  ...
  BuildQuote(entopts?: Record<string, any>) {
    const self = this
    return new BuildQuoteEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  CheckCompatibility(entopts?: Record<string, any>) {
    const self = this
    return new CheckCompatibilityEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  CompareProduct(entopts?: Record<string, any>) {
    const self = this
    return new CompareProductEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetAffiliateOffer(entopts?: Record<string, any>) {
    const self = this
    return new GetAffiliateOfferEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetBuild(entopts?: Record<string, any>) {
    const self = this
    return new GetBuildEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  GetProduct(entopts?: Record<string, any>) {
    const self = this
    return new GetProductEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  RecommendProduct(entopts?: Record<string, any>) {
    const self = this
    return new RecommendProductEntity(self, entopts)
  }
