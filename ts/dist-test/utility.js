...
function envOverride(m) {
    if ('TRUE' === process.env.SETUP_GEAR_GUIDE_TEST_LIVE ||
        'TRUE' === process.env.SETUP_GEAR_GUIDE_TEST_OVERRIDE) {
    ...
    m.SETUP_GEAR_GUIDE_TEST_EXPLAIN = process.env.SETUP_GEAR_GUIDE_TEST_EXPLAIN || m.SETUP_GEAR_GUIDE_TEST_EXPLAIN;
    return m;
}
