...
(0, node_test_1.describe)('RecommendProductDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-recommend_product', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-recommend_product', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SETUP_GEAR_GUIDE_TEST_RECOMMEND_PRODUCT_ENTID'];
...
//# sourceMappingURL=RecommendProductDirect.test.js.map