...
(0, node_test_1.describe)('RecommendProductEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'recommend_product.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != recommend_product_ref01_data);
        // LOAD
        const recommend_product_ref01_match_dt0 = {};
        const recommend_product_ref01_data_dt0 = (await recommend_product_ref01_ent.load(recommend_product_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != recommend_product_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/recommend_product/RecommendProductTestData.json');
    ...
    let idmap = transform(['recommend_product01', 'recommend_product02', 'recommend_product03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['SETUP_GEAR_GUIDE_TEST_RECOMMEND_PRODUCT_ENTID'];
...
//# sourceMappingURL=RecommendProductEntity.test.js.map