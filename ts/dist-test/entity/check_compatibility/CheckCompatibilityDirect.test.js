...
(0, node_test_1.describe)('CheckCompatibilityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-check_compatibility', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-check_compatibility', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SETUP_GEAR_GUIDE_TEST_CHECK_COMPATIBILITY_ENTID'];
...
//# sourceMappingURL=CheckCompatibilityDirect.test.js.map