...
(0, node_test_1.describe)('GetAffiliateOfferDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.SetupGearGuideSDK({
    ...
    (0, node_test_1.test)('direct-load-get_affiliate_offer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_affiliate_offer', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.SETUP_GEAR_GUIDE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SetupGearGuideSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SETUP_GEAR_GUIDE_TEST_GET_AFFILIATE_OFFER_ENTID'];
    ...
    const client = new __1.SetupGearGuideSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetAffiliateOfferDirect.test.js.map