...
(0, node_test_1.describe)('GetBuildDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_build', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_build', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SETUP_GEAR_GUIDE_TEST_GET_BUILD_ENTID'];
...
//# sourceMappingURL=GetBuildDirect.test.js.map