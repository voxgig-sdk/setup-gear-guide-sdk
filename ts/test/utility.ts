...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.SETUPGEARGUIDE_TEST_LIVE ||
    'TRUE' === process.env.SETUPGEARGUIDE_TEST_OVERRIDE
  ) {
  ...
  m.SETUPGEARGUIDE_TEST_EXPLAIN = process.env.SETUPGEARGUIDE_TEST_EXPLAIN || m.SETUPGEARGUIDE_TEST_EXPLAIN
