...
|---|---|---|
| `ts/` | @voxgig-sdk/setup-gear-guide-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/setup-gear-guide-sdk \
      --repository voxgig-sdk/setup-gear-guide-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/setup-gear-guide-sdk` shows it, and
`npm trust revoke @voxgig-sdk/setup-gear-guide-sdk --id=<id>` removes it.
