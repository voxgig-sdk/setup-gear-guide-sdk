...
// SetupGearGuide SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = SetupGearGuideOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(SetupGearGuideOmni::structfix($now, Struct::undef()))
                        !== json_encode(SetupGearGuideOmni::structfix($val, Struct::undef()))) {
