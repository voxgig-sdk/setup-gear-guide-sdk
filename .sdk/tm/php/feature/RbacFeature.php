...
// SetupGearGuide SDK rbac feature
...
class SetupGearGuideRbacFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _required(SetupGearGuideContext $ctx): ?string
    {
    ...
    private function _reject(SetupGearGuideContext $ctx, string $required): void
    {
    ...
    private function _track(SetupGearGuideContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
