...
// SetupGearGuide SDK audit feature
...
class SetupGearGuideAuditFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _emit(SetupGearGuideContext $ctx, string $outcome): void
    {
