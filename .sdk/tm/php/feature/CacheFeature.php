...
// SetupGearGuide SDK cache feature
...
class SetupGearGuideCacheFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _through(SetupGearGuideContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
