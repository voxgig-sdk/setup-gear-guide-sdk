...
// SetupGearGuide SDK clienttrack feature
...
class SetupGearGuideClienttrackFeature extends SetupGearGuideBaseFeature
{
    ...
    public function PostConstruct(SetupGearGuideContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'SetupGearGuide-SDK';
