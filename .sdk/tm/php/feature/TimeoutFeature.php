...
// SetupGearGuide SDK timeout feature
...
class SetupGearGuideTimeoutFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _with_timeout(SetupGearGuideContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SetupGearGuideContext $_ctx, float $ms): void
    {
        $client = $this->client;
