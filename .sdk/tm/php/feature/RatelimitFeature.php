...
// SetupGearGuide SDK ratelimit feature
...
class SetupGearGuideRatelimitFeature extends SetupGearGuideBaseFeature
{
    ...
    private function _acquire(SetupGearGuideContext $ctx): void
    {
    ...
    private function _track(SetupGearGuideContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
