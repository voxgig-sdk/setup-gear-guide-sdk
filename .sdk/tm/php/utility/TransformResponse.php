...
// SetupGearGuide SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class SetupGearGuideTransformResponse
{
    public static function call(SetupGearGuideContext $ctx): mixed
    {
        ...
        $transform = SetupGearGuideHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
