...
// SetupGearGuide SDK utility: fetcher

class SetupGearGuideFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SetupGearGuideSDK/1.0)';
    ...
    public static function call(SetupGearGuideContext $ctx, string $fullurl, array $fetchdef): array
    {
