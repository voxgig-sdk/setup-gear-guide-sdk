...
class SetupGearGuideTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SetupGearGuideTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SetupGearGuideTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SetupGearGuideTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
