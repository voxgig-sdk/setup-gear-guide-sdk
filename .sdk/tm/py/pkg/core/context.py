...
from projectname_sdk.core.control import SetupGearGuideControl
...
class SetupGearGuideContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = SetupGearGuideControl()
        ...
        if isinstance(sp, SetupGearGuideSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, SetupGearGuideResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, SetupGearGuideResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return SetupGearGuideOperation({})
    ...
    def make_error(self, code, msg):
        return SetupGearGuideError(code, msg, self)
