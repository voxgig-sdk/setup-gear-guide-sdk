...
func registerSDKWords(r *eng.Registry, client *sdk.SetupGearGuideSDK) {
...
func runOp(client *sdk.SetupGearGuideSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
