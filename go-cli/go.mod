module github.com/voxgig-sdk/setup-gear-guide-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/setup-gear-guide-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/setup-gear-guide-sdk/go => ../go
