// Command SetupGearGuide-mcp is an MCP server exposing the SetupGearGuide
// SDK as MCP tools.
//
// Two tools are registered:
//
//	SetupGearGuide_list  — list records of an entity
//	SetupGearGuide_load  — load a single record of an entity
//
