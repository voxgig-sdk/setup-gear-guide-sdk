# SetupGearGuide Ruby SDK



The Ruby SDK for the SetupGearGuide API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `SetupGearGuideError` (a `StandardError` subclass), so wrap
...
```
rb/
├── SetupGearGuide_sdk.rb       -- Main SDK module
