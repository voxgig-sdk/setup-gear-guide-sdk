...
class CompareProductEntity
  ...
  def make
    opts = @_entopts.dup
    CompareProductEntity.new(@_client, opts)
  end
  ...
  # @return [CompareProduct, Hash] the current CompareProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CompareProduct fields)
  def match_get
  ...
  #
  # @param reqmatch [CompareProductLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.CompareProduct.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [CompareProduct, Hash] the loaded CompareProduct; raises SetupGearGuideError on failure
  ...
  #
  # @param reqdata [CompareProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [CompareProduct, Hash] the created CompareProduct; raises SetupGearGuideError on failure
