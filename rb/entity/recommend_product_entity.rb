...
class RecommendProductEntity
  ...
  def make
    opts = @_entopts.dup
    RecommendProductEntity.new(@_client, opts)
  end
  ...
  # @return [RecommendProduct, Hash] the current RecommendProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of RecommendProduct fields)
  def match_get
  ...
  #
  # @param reqmatch [RecommendProductLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.RecommendProduct.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [RecommendProduct, Hash] the loaded RecommendProduct; raises SetupGearGuideError on failure
  ...
  #
  # @param reqdata [RecommendProductCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [RecommendProduct, Hash] the created RecommendProduct; raises SetupGearGuideError on failure
