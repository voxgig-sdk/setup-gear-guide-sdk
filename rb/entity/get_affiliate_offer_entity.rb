...
class GetAffiliateOfferEntity
  ...
  def make
    opts = @_entopts.dup
    GetAffiliateOfferEntity.new(@_client, opts)
  end
  ...
  # @return [GetAffiliateOffer, Hash] the current GetAffiliateOffer data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetAffiliateOffer fields)
  def match_get
  ...
  #
  # @param reqmatch [GetAffiliateOfferLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetAffiliateOffer.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetAffiliateOffer, Hash] the loaded GetAffiliateOffer; raises SetupGearGuideError on failure
