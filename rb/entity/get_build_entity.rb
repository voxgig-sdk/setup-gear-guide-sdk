...
class GetBuildEntity
  ...
  def make
    opts = @_entopts.dup
    GetBuildEntity.new(@_client, opts)
  end
  ...
  # @return [GetBuild, Hash] the current GetBuild data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetBuild fields)
  def match_get
  ...
  #
  # @param reqmatch [GetBuildLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetBuild.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetBuild, Hash] the loaded GetBuild; raises SetupGearGuideError on failure
