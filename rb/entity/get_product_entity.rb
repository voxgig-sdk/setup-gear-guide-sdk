...
class GetProductEntity
  ...
  def make
    opts = @_entopts.dup
    GetProductEntity.new(@_client, opts)
  end
  ...
  # @return [GetProduct, Hash] the current GetProduct data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of GetProduct fields)
  def match_get
  ...
  #
  # @param reqmatch [GetProductLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.GetProduct.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [GetProduct, Hash] the loaded GetProduct; raises SetupGearGuideError on failure
