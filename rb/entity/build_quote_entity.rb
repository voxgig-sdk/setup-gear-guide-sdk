...
class BuildQuoteEntity
  ...
  def make
    opts = @_entopts.dup
    BuildQuoteEntity.new(@_client, opts)
  end
  ...
  # @return [BuildQuote, Hash] the current BuildQuote data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of BuildQuote fields)
  def match_get
  ...
  #
  # @param reqmatch [BuildQuoteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.BuildQuote.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [BuildQuote, Hash] the loaded BuildQuote; raises SetupGearGuideError on failure
  ...
  #
  # @param reqdata [BuildQuoteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [BuildQuote, Hash] the created BuildQuote; raises SetupGearGuideError on failure
