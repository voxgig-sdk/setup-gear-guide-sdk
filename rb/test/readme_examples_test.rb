...
#      offline in seeded test mode (SetupGearGuideSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "SetupGearGuide_sdk.rb")
  SDK_CLASS = "SetupGearGuideSDK"
