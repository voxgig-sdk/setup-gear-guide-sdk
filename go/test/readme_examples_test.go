...
const testSeed = `map[string]any{"entity": map[string]any{"build_quote": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "check_compatibility": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "compare_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_affiliate_offer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_build": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "get_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "recommend_product": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
