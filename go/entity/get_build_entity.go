...
func NewGetBuildEntity(client *core.SetupGearGuideSDK, entopts map[string]any) *GetBuildEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetBuildEntity) GetName() string { return e.name }
...
func (e *GetBuildEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetBuildEntity) Deleted() bool {
	return e.deleted
}


func (e *GetBuildEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetBuildEntity(e.client, opts)
}

func (e *GetBuildEntity) Data(args ...any) any {
...
func (e *GetBuildEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetBuild; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetBuildEntity) DataTyped(data ...GetBuild) GetBuild {
	if len(data) > 0 {
		return typedFrom[GetBuild](e.Data(asMap(data[0])))
	}
	return typedFrom[GetBuild](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetBuild (all fields
// optional at the wire level).
func (e *GetBuildEntity) MatchTyped(match ...GetBuild) GetBuild {
	if len(match) > 0 {
		return typedFrom[GetBuild](e.Match(asMap(match[0])))
	}
	return typedFrom[GetBuild](e.Match())
}
...
func (e *GetBuildEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetBuildEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetBuildLoadMatch and returns an GetBuild. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetBuildEntity) LoadTyped(reqmatch GetBuildLoadMatch, ctrl map[string]any) (GetBuild, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetBuild{}, err
	}
	return typedFrom[GetBuild](res), nil
}



func (e *GetBuildEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetBuildEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetBuildEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetBuildEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetBuildEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
