...
type GetAffiliateOfferEntity struct {
	name    string
...
func NewGetAffiliateOfferEntity(client *core.SetupGearGuideSDK, entopts map[string]any) *GetAffiliateOfferEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetAffiliateOfferEntity) GetName() string { return e.name }
...
func (e *GetAffiliateOfferEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetAffiliateOfferEntity) Deleted() bool {
	return e.deleted
}


func (e *GetAffiliateOfferEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetAffiliateOfferEntity(e.client, opts)
}

func (e *GetAffiliateOfferEntity) Data(args ...any) any {
...
func (e *GetAffiliateOfferEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetAffiliateOffer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetAffiliateOfferEntity) DataTyped(data ...GetAffiliateOffer) GetAffiliateOffer {
	if len(data) > 0 {
		return typedFrom[GetAffiliateOffer](e.Data(asMap(data[0])))
	}
	return typedFrom[GetAffiliateOffer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetAffiliateOffer (all fields
// optional at the wire level).
func (e *GetAffiliateOfferEntity) MatchTyped(match ...GetAffiliateOffer) GetAffiliateOffer {
	if len(match) > 0 {
		return typedFrom[GetAffiliateOffer](e.Match(asMap(match[0])))
	}
	return typedFrom[GetAffiliateOffer](e.Match())
}
...
func (e *GetAffiliateOfferEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetAffiliateOfferEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetAffiliateOfferLoadMatch and returns an GetAffiliateOffer. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetAffiliateOfferEntity) LoadTyped(reqmatch GetAffiliateOfferLoadMatch, ctrl map[string]any) (GetAffiliateOffer, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetAffiliateOffer{}, err
	}
	return typedFrom[GetAffiliateOffer](res), nil
}



func (e *GetAffiliateOfferEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetAffiliateOfferEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetAffiliateOfferEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetAffiliateOfferEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetAffiliateOfferEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
