...
func NewBuildQuoteEntity(client *core.SetupGearGuideSDK, entopts map[string]any) *BuildQuoteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BuildQuoteEntity) GetName() string { return e.name }
...
func (e *BuildQuoteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BuildQuoteEntity) Deleted() bool {
	return e.deleted
}


func (e *BuildQuoteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBuildQuoteEntity(e.client, opts)
}

func (e *BuildQuoteEntity) Data(args ...any) any {
...
func (e *BuildQuoteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an BuildQuote; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BuildQuoteEntity) DataTyped(data ...BuildQuote) BuildQuote {
	if len(data) > 0 {
		return typedFrom[BuildQuote](e.Data(asMap(data[0])))
	}
	return typedFrom[BuildQuote](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through BuildQuote (all fields
// optional at the wire level).
func (e *BuildQuoteEntity) MatchTyped(match ...BuildQuote) BuildQuote {
	if len(match) > 0 {
		return typedFrom[BuildQuote](e.Match(asMap(match[0])))
	}
	return typedFrom[BuildQuote](e.Match())
}
...
func (e *BuildQuoteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BuildQuoteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BuildQuoteLoadMatch and returns an BuildQuote. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BuildQuoteEntity) LoadTyped(reqmatch BuildQuoteLoadMatch, ctrl map[string]any) (BuildQuote, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return BuildQuote{}, err
	}
	return typedFrom[BuildQuote](res), nil
}



func (e *BuildQuoteEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *BuildQuoteEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// BuildQuoteCreateData and returns an BuildQuote. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BuildQuoteEntity) CreateTyped(reqdata BuildQuoteCreateData, ctrl map[string]any) (BuildQuote, error) {
...
func (e *BuildQuoteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BuildQuoteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BuildQuoteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
