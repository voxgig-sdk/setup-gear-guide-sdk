...
func NewGetProductEntity(client *core.SetupGearGuideSDK, entopts map[string]any) *GetProductEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetProductEntity) GetName() string { return e.name }
...
func (e *GetProductEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetProductEntity) Deleted() bool {
	return e.deleted
}


func (e *GetProductEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetProductEntity(e.client, opts)
}

func (e *GetProductEntity) Data(args ...any) any {
...
func (e *GetProductEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GetProduct; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GetProductEntity) DataTyped(data ...GetProduct) GetProduct {
	if len(data) > 0 {
		return typedFrom[GetProduct](e.Data(asMap(data[0])))
	}
	return typedFrom[GetProduct](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GetProduct (all fields
// optional at the wire level).
func (e *GetProductEntity) MatchTyped(match ...GetProduct) GetProduct {
	if len(match) > 0 {
		return typedFrom[GetProduct](e.Match(asMap(match[0])))
	}
	return typedFrom[GetProduct](e.Match())
}
...
func (e *GetProductEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetProductEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GetProductLoadMatch and returns an GetProduct. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GetProductEntity) LoadTyped(reqmatch GetProductLoadMatch, ctrl map[string]any) (GetProduct, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GetProduct{}, err
	}
	return typedFrom[GetProduct](res), nil
}



func (e *GetProductEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetProductEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetProductEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetProductEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetProductEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
