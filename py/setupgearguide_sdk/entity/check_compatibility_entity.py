...
from setupgearguide_sdk.setupgearguide_types import (
    CheckCompatibility,
...
class CheckCompatibilityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CheckCompatibilityEntity(self._client, opts)
    ...
    def data_get(self) -> CheckCompatibility:
    ...
    def match_get(self) -> CheckCompatibility:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CheckCompatibility:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CheckCompatibility().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CheckCompatibilityCreateData, ctrl=None) -> CheckCompatibility:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
