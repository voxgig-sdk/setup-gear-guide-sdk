...
class GetAffiliateOfferEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GetAffiliateOfferEntity(self._client, opts)
    ...
    def data_get(self) -> GetAffiliateOffer:
    ...
    def match_get(self) -> GetAffiliateOffer:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GetAffiliateOffer:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GetAffiliateOffer().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
