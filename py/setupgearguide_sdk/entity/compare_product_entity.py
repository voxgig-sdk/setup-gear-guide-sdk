...
class CompareProductEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CompareProductEntity(self._client, opts)
    ...
    def data_get(self) -> CompareProduct:
    ...
    def match_get(self) -> CompareProduct:
    ...
    def load(self, reqmatch=None, ctrl=None) -> CompareProduct:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.CompareProduct().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: CompareProductCreateData, ctrl=None) -> CompareProduct:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
