# SetupGearGuide SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SetupGearGuideSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SetupGearGuideSDK(...) and SetupGearGuideSDK.test(...) become
#      SetupGearGuideSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "setupgearguide_sdk"
_SDK_CLASS = "SetupGearGuideSDK"
...
_ENTITIES = {
    ...
    "GetAffiliateOffer": "get_affiliate_offer",
    "GetBuild": "get_build",
